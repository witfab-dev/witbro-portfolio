...
const translations = {
  ...
  rw: {
    ...
    internship: "Ubuhabwa"
    architectureMicroservices: "Kubaka microervices bikura no kuyobora imyimura ya frontend kuri Next.js. Kwongera umuvuduko wa sisitemu ku 40% binyuze mu gushyira mu cache neza no kunoza ibisabwa.",
    interactiveDashboards: "Gukora ibipimo by'ishusho ry'ibyatanzwe bigaragaza ibyabaye bigeze kuri 100k+ ku munsi. Kuba umushinga wa mbere mu guhuza amategeko y'ijwi ya AI, ,
    fullTime: "Akazi k'aka
    keyMetrics: "Ibipimo by'ingenzi bigabanya igihe cyo kuyobora ku 35%.",
