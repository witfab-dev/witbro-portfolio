...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t bg-[#0c0b0a] border-stone-800/60 transition-colors duration-500">
      ...
      <div className="relative border-b border-stone-800/60">
        <div className="max-w-[1200px] mx-auto px-6 py-16 sm:py-20 flex flex-col md:flex-row md:items-end justify-between gap-10">
          ...
          >
            ...
            <h2 className="text-[clamp(36px,5vw,60px)] font-black leading-[0.93] tracking-tight text-stone-100">
              Have a project
              <br />
          ...
          >
            ...
            <div className="relative flex items-center gap-4 p-4 pr-3 rounded-2xl border bg-[#161513] border-stone-800/60 shadow-sm">
              {/* Icon */}
              ...
              <div className="min-w-0">
                <p className="text-[9px] font-bold tracking-[0.18em] uppercase mb-0.5 text-stone-500">Email me</p>
                <p className="text-sm font-mono truncate text-stone-100">{EMAIL}</p>
              </div>
              ...
              <button
                ...
                className="ml-auto shrink-0 w-9 h-9 flex items-center justify-center rounded-xl border border-stone-800/60 text-stone-500 hover:bg-orange-500 hover:text-white hover:border-orange-500 active:scale-90 transition-all"
              >
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
        ...
        >
          ...
          <div>
            <motion.p
              ...
              className="font-black text-3xl tracking-tight cursor-default text-stone-100"
            >
              WITNESS
              <span className="text-orange-500">_</span>
              Fabrice
            </motion.p>
            <p className="mt-3 text-sm leading-relaxed max-w-xs text-stone-400">
              Building the future of the web from the heart of{' '}
              <span className="text-stone-100 border-b border-orange-400/50">Rwanda</span>.
              Focused on immersive interfaces and high-performance ecosystems.
            </p>
          </div>

          {/* Location + live time */}
          <div className="inline-flex items-center gap-3 px-4 py-2.5 rounded-xl border bg-[#161513] border-stone-800/60 w-fit">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75" />
              <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500" />
            </span>
            <MapPin size={12} className="text-orange-400" />
            <span className="text-[11px] font-semibold tracking-wide text-stone-100">Kigali, Rwanda</span>
            <span className="text-[10px] font-mono text-stone-500 pl-1 border-l border-stone-800/60">{kigaliTime}</span>
          </div>
          ...
          <div className="flex gap-2.5">
            {SOCIAL_LINKS.map(({ name, url, icon: Icon, bg: hoverBg }) => (
              <motion.a
                ...
                whileTap={{ scale: 0.92 }}
                className={`w-10 h-10 flex items-center justify-center rounded-xl border border-stone-800/60 bg-[#161513] text-stone-500 ${hoverBg} hover:text-white hover:border-transparent transition-all duration-300`}
              >
                <Icon size={16} />
              </motion.a>
            ))}
        ...
        >
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] mb-5 text-stone-500">Navigation</p>
          <ul className="space-y-3">
            {NAV_LINKS.map(({ label, href }) => (
              <li key={label}>
                <a
                  href={href}
                  className="group flex items-center gap-2 text-sm font-medium text-stone-400 hover:text-orange-500 transition-colors duration-200"
                >
        ...
        <motion.div
          ...
          className="lg:col-span-3"
        >
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] mb-5 text-stone-500">Status</p>

          {/* Availability card */}
          <div className="p-4 rounded-2xl border bg-[#161513] border-stone-800/60 mb-4">
      ...
      <div className="border-t border-stone-800/60">
        <div className="max-w-[1200px] mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[11px] font-mono text-stone-500">
            ...
            <span className="text-stone-400">Designed & built by WITDEV</span>
          </p>
          ...
          <motion.button
            ...
            whileHover={{ y: -3 }}
            whileTap={{ scale: 0.94 }}
            className="group flex items-center gap-2.5 text-[10px] font-bold uppercase tracking-widest text-stone-500 hover:text-orange-500 transition-colors"
          >
            <span>{t('scrollTop') || 'Back to top'}</span>
            <div className="w-7 h-7 flex items-center justify-center rounded-full border border-stone-800/60 group-hover:border-orange-500 group-hover:bg-orange-500 transition-all">
