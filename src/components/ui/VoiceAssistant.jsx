...
import {
  ...
  Lightbulb, Handshake, Coffee, Award, Target, Compass,import React, { useState, useEffect, useCallback, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import {
  Mic, MicOff, Volume2, VolumeX, X, Send,
  User, Zap, Code2, Mail, Briefcase, MapPin,
  Bot, RotateCcw, Sparkles, GraduationCap,
  Award, Coffee, Smile
} from "lucide-react";
...
class FriendlyResponseEngine {
  ...
  generateAchievementResponse() {
    ...
    const responses = [
      ...
      `Witness is collecting awards like Pokemon! 🎯 He's got ${awards} and certifications in ${certs}. So much dedication! 💫`,
    ];
    return responses[Math.floor(Math.random() * responses.length)];
  }
